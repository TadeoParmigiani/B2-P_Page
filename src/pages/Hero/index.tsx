    ...
    <section className="relative min-h-100 md:min-h-125 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-2 text-gray-200 mb-6">
          ...
          <span>Blvd. 27 de Febrero 2672, Rosario</span>
        </div>
        <a 
          href="#reservar"
          className="inline-flex items-center gap-2 bg-primary hover:bg-(--green-600) text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-200"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a 
          ...
          className="block mt-4 text-primary hover:text-(--green-600) font-medium transition-colors"
        >
          (ver en mapa)
        </a>
      </div>
